...
import pickle  
import numpy as np
# function that open model file (file that loaded)
# and storage this file in mlp_loaded 
def load_model():
...
# predict page that we show 
def show_predict_page():
    st.image("cardiologo.png")
    ...
    if ok:
        # save the inputs from the user to send it to machine 
        ...
        if Prediction==1:
            ...
            st.image("Screenshot 2022-05-29 123241.png",width=200)
